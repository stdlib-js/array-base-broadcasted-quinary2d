...
```javascript
bquinary2d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-broadcasted-quinary2d@v0.1.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-base-broadcasted-quinary2d/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/array-base-broadcasted-quinary2d/actions/workflows/test.yml?query=branch:v0.1.2
